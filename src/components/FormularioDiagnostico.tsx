            ...
            <div className="bg-blue-50 border border-blue-150 rounded-2xl p-4 max-w-sm mx-auto space-y-2">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="px-3 py-1.5 bg-white hover:bg-gray-100 border border-blue-200 text-blue-700 font-bold text-[10px] rounded-lg transition shadow-sm flex items-center gap-1.5 cursor-pointer select-none"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" className="w-3.5 h-3.5 text-blue-700">
