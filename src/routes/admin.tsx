...
- cons: string o null (limitantes técnicas, físicas o químicas REALES y específicas de resistencia o compatibilidad del producto extraídas exclusivamente del texto. Ejemplos permitidos: "no resistente a rayos UV", "no resistente a químicos", "no se puede mezclar con asfalto", "no se puede mezclar con poliuretano", "no apto para inmersión constante", "sensible a la humedad". CRÍTICO: Queda estrictamente prohibido incluir recomendaciones genéricas de aplicación, preparación de superficie o sentido común, como por ejemplo "no sobre pintura vieja", "no mezclar marcas", "no con lluvia", "no aplicar en frío", etc. Si el documento no menciona limitantes de compatibilidad o químicas específicas y estrictas del producto, establece su valor exactamente como null)
- cuidadoCon: string o null (advertencias críticas de seguridad o aplicación que sean específicas de la naturaleza química o técnica de este material y estén explícitas en el texto. Ejemplos permitidos: "inflamable", "irritante cutáneo", "requiere ventilación forzada", "tiempo de vida de mezcla corto (20 min)", "tóxico al inhalar". CRÍTICO: Queda estrictamente prohibido incluir advertencias genéricas de sentido común, generales o universales de seguridad o aplicación, como por ejemplo "usar EPP", "usar guantes", "usar lentes", "no ingerir", "evitar contacto", "mantener fuera del alcance de niños". Si el documento no menciona advertencias específicas de esta clase, establece su valor exactamente como null)
- proporcionesMezcla: string o null (proporción de mezcla si es kit, o de volumen A:B, ej: "4 partes A : 1 parte B")

REGLA DE GUARDRAIL CRÍTICA: Queda estrictamente prohibido alucinar, inventar, deducir o asumir información genérica o de sentido común. Si un dato, limitante o advertencia no está explícitamente mencionado en el texto de la ficha técnica/seguridad, debes establecer su valor exactamente en null. No rellenes campos con suposiciones de la industria o consejos de aplicación que no vengan en el documento.
